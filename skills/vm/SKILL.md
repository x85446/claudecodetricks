...
argument-hint: <what you want, e.g. "run the test suite on a linux box" or "fresh windows VM called win1" or "snapshot vtest then upgrade it">
---
...
Only ask the user (AskUserQuestion) when the request is genuinely ambiguous about
