...
- **Orchestrator / Project Management** (Manager: green, Staff: cyan)
  - Orchestrator-Project-Manager - *Project Orchestrator*
  - Orchestrator-Build-Engineer - *Build Engineer*
  - Orchestrator-Documentation-Engineer - *Documentation Engineer*
- **Marketing** (Manager: blue, Staff: orange)
  - Marketing-Manager - *Marketing Manager*
  - Marketing-Brand-Strategist - *Brand Strategist*
  - Marketing-Content-Specialist - *Content Marketing Specialist*
  - Marketing-Social-Media-Specialist - *Social Media Specialist*
  - Marketing-SEO-Specialist - *SEO/Growth Specialist*
  - Marketing-Analytics-Specialist - *Analytics & Insights Specialist*
- **Product** (Manager: blue, Staff: orange)
  - Product-Manager - *Product Manager*
  - Product-Analyst - *Product Analyst*
  - Product-UX-Researcher - *UX Researcher*
  - Product-Designer - *Product Designer*
  - Product-Technical-Manager - *Technical Product Manager*
- **Operations** (Manager: blue, Staff: orange)
  - Operations-Manager - *DevOps Manager*
  - Operations-CICD-Engineer - *CI/CD Engineer*
  - Operations-Infrastructure-Engineer - *Infrastructure Engineer*
  - Operations-Platform-Engineer - *Platform Engineer*
  - Operations-SRE-Engineer - *SRE/Reliability Engineer*
- **Frontend** (Manager: blue, Staff: purple)
  - Frontend-Manager - *Frontend Manager*
  - Frontend-React-Developer - *React Developer*
  - Frontend-UI-Engineer - *UI Engineer*
  - Frontend-Accessibility-Specialist - *Accessibility Specialist*
  - Frontend-Performance-Engineer - *Frontend Performance Engineer*
  - Frontend-Testing-Specialist - *Frontend Testing Specialist*
- **Backend** (Manager: blue, Staff: cyan)
  - Backend-Manager - *Backend Manager*
  - Backend-API-Engineer - *API Engineer*
  - Backend-Database-Engineer - *Database Engineer*
  - Backend-Integration-Engineer - *Integration Engineer*
  - Backend-Security-Engineer - *Security Engineer*
  - Backend-Performance-Engineer - *Backend Performance Engineer*
- **Architecture** (Manager: blue, Staff: yellow)
  - Architecture-Manager - *Architecture Manager*
  - Architecture-Solutions-Architect - *Solutions Architect*
  - Architecture-Data-Architect - *Data Architect*
  - Architecture-Security-Architect - *Security Architect*
  - Architecture-Infrastructure-Architect - *Infrastructure Architect*
- **Quality** (Manager: red, Staff: pink)
  - Quality-Manager - *Quality Manager*
  - Quality-Test-Automation-Engineer - *Test Automation Engineer*
  - Quality-Performance-Test-Engineer - *Performance Test Engineer*
  - Quality-Security-Test-Engineer - *Security Test Engineer*
...
### Team colors and shorthands
| Team Domain | Short | Manager Color | Staff Specialist Color |
|-------------|-------|--------|--------------|
| Orchestrator / project management | PJM |green | cyan |
| Marketing | MKT | blue | orange |
| Product | PM | blue | orange |
| Operations | OPS | blue | orange |
| Frontend | EFD | blue | purple |
| Backend | EBK | blue | cyan |
| Architecture | ARC | blue | yellow |
| Quality | QA | red | pink |
