...
import type { Expand, HTMLDivAttributes, Transition, PrefixKeys } from '../internal';
...
type TransitionProps = 'transition' | 'transitionConfig' | 'inTransition' | 'inTransitionConfig' | 'outTransition' | 'outTransitionConfig';
export type OverlayProps<T extends Transition = Transition, In extends Transition = Transition, Out extends Transition = Transition> = PrefixKeys<Pick<DialogPrimitive.OverlayProps<T, In, Out>, TransitionProps>, 'overlay'> & {
    overlayClasses?: string;
};
export type ContentProps<T extends Transition = Transition, In extends Transition = Transition, Out extends Transition = Transition> = PrefixKeys<Pick<DialogPrimitive.ContentProps<T, In, Out>, TransitionProps>, 'content'> & {
    contentClasses?: string;
};
export type DialogProps<ContentT extends Transition = Transition, ContentIn extends Transition = Transition, ContentOut extends Transition = Transition, OverlayT extends Transition = Transition, OverlayIn extends Transition = Transition, OverlayOut extends Transition = Transition> = CommandProps & DialogPrimitive.Props & OverlayProps<OverlayT, OverlayIn, OverlayOut> & ContentProps<ContentT, ContentIn, ContentOut>;
