            ...
            if (!this.resultHandler) {
                ...
                switch (resultFormat) {
                    case TCLIService_types_1.TSparkRowSetType.COLUMN_BASED_SET:
                        resultSource = new JsonResultHandler_1.default(this.context, this._data, metadata.schema);
                        break;
                    case TCLIService_types_1.TSparkRowSetType.ARROW_BASED_SET:
                        resultSource = new ArrowResultConverter_1.default(this.context, new ArrowResultHandler_1.default(this.context, this._data, metadata.arrowSchema), metadata.schema);
                        break;
                    case TCLIService_types_1.TSparkRowSetType.URL_BASED_SET:
                        resultSource = new ArrowResultConverter_1.default(this.context, new CloudFetchResultHandler_1.default(this.context, this._data), metadata.schema);
                        break;
                    // no default
                }
                if (resultSource) {
