...
export function readMetadata(a: number, b: number, c: number): void;
export function readRowGroup(a: number, b: number, c: number, d: number, e: number): void;
export function readMetadataAsync(a: number, b: number, c: number, d: number): number;
export function readRowGroupAsync(a: number, b: number, c: number, d: number): number;
export function writeParquet(a: number, b: number, c: number): void;
export function readParquetStream(a: number, b: number): number;
...
export function filemetadata_copy(a: number): number;
...
export function filemetadata_numRowGroups(a: number): number;
export function filemetadata_rowGroup(a: number, b: number): number;
export function filemetadata_schema(a: number): number;
export function filemetadata_keyValueMetadata(a: number, b: number): void;
export function filemetadata_arrowSchema(a: number, b: number): void;
...
export function columnchunkmetadata_pathInSchema(a: number, b: number): void;
export function columnchunkmetadata_statistics_exist(a: number, b: number): void;
export function columnchunkmetadata_getStatisticsMinValue(a: number, b: number): void;
export function columnchunkmetadata_getStatisticsMaxValue(a: number, b: number): void;
export function columnchunkmetadata_getStatisticsNullCount(a: number, b: number): void;
...
export function columnchunkmetadata_dataPageOffset(a: number): number;
export function columnchunkmetadata_hasIndexPage(a: number): number;
export function columnchunkmetadata_indexPageOffset(a: number, b: number): void;
export function columnchunkmetadata_dictionaryPageOffset(a: number, b: number): void;
export function columnchunkmetadata_numColumnEncodings(a: number): number;
export function columnchunkmetadata_byteRange(a: number, b: number): void;
export function __wbg_schemadescriptor_free(a: number): void;
export function schemadescriptor_name(a: number, b: number): void;
export function schemadescriptor_numColumns(a: number): number;
export function schemadescriptor_numFields(a: number): number;
export function __wbg_arrowschema_free(a: number): void;
export function arrowschema_copy(a: number): number;
...
export function recordbatch_column_by_name(a: number, b: number, c: number): number;
...
export function ffivector_array_addr(a: number): number;
export function ffivector_field_addr(a: number): number;
...
export function table_fromIPCFile(a: number, b: number, c: number): void;
...
export function vector_data_type(a: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h896648893be04d51(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h02232cd008ae4dfe(a: number, b: number, c: number, d: number): void;
